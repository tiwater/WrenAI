...
import { useSelectedProject } from '@/contexts/ProjectContext';import { useRouter } from 'next/router';
import { SelectedRecommendRelations } from '@/components/pages/setup/DefineRelations';
import { useSelectedProject } from '@/contexts/ProjectContext';import { Path } from '@/utils/enum';
...
export default function useSetupRelations() {
  const projectId = useSelectedProject();  const [stepKey] = useState(SETUP.DEFINE_RELATIONS);
