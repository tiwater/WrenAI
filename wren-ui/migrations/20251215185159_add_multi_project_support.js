...
exports.up = function (knex) {
  return knex.schema.table('project', (table) => {
    ...
    table.string('name').nullable().comment('Project name for identification');
    ...
    table.timestamp('last_accessed_at').nullable().comment('Last time this project was accessed');
